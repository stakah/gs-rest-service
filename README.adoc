...
This repository is a copy from the tutorial at https://spring.io/guides/gs/rest-service/
...
Additionally, it has the `loremipsum` endpoint that returns the Lorem Ipsum text. To get bigger or smaller text, pass the `len` parameter with the number of characters to return.
...
Lorem Ipsum endpoint

----
http://localhost:8080/loremipsum
----
...
----
http://localhost:8080/loremipsum?len=1311
----
